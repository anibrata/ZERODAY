...
class EnsembleClassifier:
    ...
    def predict_class(self, X):
        ...
        # out.
        # preds[preds == 0] = 1e-9
        preds = np.where(preds == 0, 1e-9, preds)
        # The above line was added by Anibrata. Added because of the error
        # preds[preds == 0] = 1e-9 # TypeError: 'numpy.float64' object does not
